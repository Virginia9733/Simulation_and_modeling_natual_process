...
'''
To validate your three-dimensional implementation, 
what is at iteration i=500 the z-component of the position of the first body in the list “bodies”?

'''

firstbody = bodies[0]

print(firstbody.m_pos[2]) # result is: 0.49860944653224387 Correct!!!
