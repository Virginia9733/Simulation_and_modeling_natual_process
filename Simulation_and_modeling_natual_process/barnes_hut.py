...
'''
To validate your two-dimensional implementation, 
what is at iteration i=500 the y-component of the position of the first body in the list “bodies”?

'''

firstbody = bodies[0]

print(firstbody.m_pos[1])  # result is: 0.49024211149057384